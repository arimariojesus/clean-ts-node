import { DbSaveSurveyResult } from './db-save-surevy-result'
import { SaveSurveyResultParams, SurveyResultModel, SaveSurveyResultRepository } from './db-save-surevy-result-protocols'
